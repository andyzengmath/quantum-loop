...
| Audit MEDIUM (1 deferred PARALLEL_MODE COMPLETE/BLOCKED pair + bonus MAX_ITERATIONS) | US-001 T-001-3 | All migrated to emit_terminal_signal |
...
- **Bundle size sequence: ...4-7-5-5-4-6-5-5-6.** v0.10.0 = 6 stories (US-003 deferred but counted).
